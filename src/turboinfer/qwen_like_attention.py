...
from turboinfer.kernels.rope import precompute_rope_angles, triton_cached_decode_rope, triton_cached_decode_rope_qk
...
def _apply_decode_rope_qk(
    ...
    if q.is_cuda and k.is_cuda:
        return triton_cached_decode_rope_qk(q, k, cos_values, sin_values)
    return (
        _apply_split_half_rope_with_cos_sin(q, cos_values, sin_values),
        _apply_split_half_rope_with_cos_sin(k, cos_values, sin_values),
    )
